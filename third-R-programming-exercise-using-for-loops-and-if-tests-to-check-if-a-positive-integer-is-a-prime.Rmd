...
The first function in this sequence will be **isItPrime(n)** whose argument is a positive integer n less 
than 1,000,000 (just to avoid accidently starting an extremely time consuming calculation) 
...
Or, in this case, since the code worked before, look at the effect of what was changed, 
